...
# Load dataset
Agg_States24_df = pd.read_csv('C:/Users/user/OneDrive/Desktop/pro/Aggregated/states_24(4).csv')
...
# Check unique state names after replacement
#print(aggragated_df['state'].unique())

# Which CSV states are not in GeoJSON?
missing = set(Agg_States24_df['state']) - set(geo_states)
#print("Mismatched states:", missing)
fig = pxpip.choropleth(
    Agg_States24_df,
    geojson=geojson,
    ...
    title="PhonePe Transactions by State"
)
